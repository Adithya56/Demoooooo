...
<head>
	...
	$(document).on('click', '#edit-button', function(event) {
	    ...
	    var gstcid = $('#prodGstcId-input').val();
	    var imageurl = $('#imageUrl-input').val();
	    var prodDesc = $('#prodDesc-input').val();
	    var reorderlevel = $('#reorderlevel-input').val();
	    var stock = parseFloat($('#prodStock-input').val());
	    var mrp = parseFloat($('#prodMrp-input').val());
	    
	    console.log('Clicked button with gstc ID:', gstcid);
	    updateMasterEntry(gstcid, imageurl, prodid, reorderlevel, stock, mrp);
	});

	function updateMasterEntry(gstcid, imageurl, prodid, reorderlevel, stock, mrp) {
	    $.ajax({
    ...
    <div class="dashboard" id="dashboard">
        ...
        <ul>
            ...
            <ul class="sub-menu" >
                ...
                <li><a  href=# id="add-new-product-link">Add New Product</a></li>
